...
function vLuogo(q) {
  ...
  let h = `<button class="sec" onclick="S.loc=null;render()">‹ ${q.nome}</button><div class="qhero phero"><img src="${ART_BASE}p/${p}.webp" alt="" onerror="this.parentNode.classList.add('noimg')"><div class="qh"><h2>${d.icon} ${d.nome}</h2></div></div>`;
